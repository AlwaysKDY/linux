...
public class ReadController {
    ...
    public String readBook(@RequestParam String username,@RequestParam int bookId){
        ...
        List<DessertPurchase>dessertPurchases = dessertPurchaseMapper.selectByUid(user.getId());
        int i=0;
        for(DessertPurchase dessertPurchase:dessertPurchases){
            if(Objects.equals(dessertPurchase.getBuyTime(), new Date().toString()))i=1;
        }
        if(i==0&& Objects.equals(user.getVip_class(), "0"))return "未购买甜品且非会员无法入内";
